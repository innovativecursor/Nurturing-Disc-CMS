          ...
          {forgotPassword ? (
            ...
            <>
              ...
              <div className="flex justify-around items-center flex-row mt-6">
                <Button
                  type="primary"
                  className="flex text-white text-2xl bg-[#faba1f] justify-around items-center flex-row"
                  size="large"
                  onClick={onLogin}
                  style={{
                    width: "45%",
                ...
                <Button
                  type="primary"
                  size="large"
                  className="flex justify-center items-center text-black bg-white text-2xl"
